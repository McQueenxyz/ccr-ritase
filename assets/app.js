...
(function () {
  ...
  const ICONS = {
    ...
    mineral: '<path d="M2.25 20.25h19.5"/><path d="M3.75 20.25c1.6-5.7 4.5-9.15 8.25-9.15s6.65 3.45 8.25 9.15"/><path d="M8.25 20.25c.95-2.85 2.25-4.6 3.75-4.6s2.8 1.75 3.75 4.6"/><path d="M12 11.1V7.5m-2.4 4.2L7.8 8.7m6.6 3-1.8-3"/>',
